...
const AttendanceRequests = () => {
  ...
  const generateTextBasedPDF = async (meeting) => {
    ...
    pdf.roundedRect(barX, whiteBarY, barWidth, whiteBarHeight, radius, radius, "F");
    pdf.saveGraphicsState();
    pdf.roundedRect(barX, whiteBarY, barWidth, whiteBarHeight + radius, radius, radius, "F");
    ...
    pdf.text("Attendance Confirmation", pageWidth / 2, whiteBarY + 8, { align: "center" });
    ...
    pdf.text("Live Online Video Meetings", pageWidth / 2, orangeBarY + 8, { align: "center" });
    ...
    pdf.line(box1X + linePadding, boxY + 12, box1X + boxWidth - linePadding, boxY + 12);
    pdf.setFont("helvetica", "normal");
    pdf.setFontSize(10);
    pdf.setTextColor(255, 255, 255);
    pdf.text(
    ...
    pdf.setDrawColor(255, 255, 255);
    pdf.setLineWidth(0.7);
    pdf.line(box2X + linePadding, boxY + 12, box2X + boxWidth - linePadding, boxY + 12);
    pdf.setFont("helvetica", "normal");
    pdf.setFontSize(10);
