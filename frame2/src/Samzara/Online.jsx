        ...
        <div className="bg-white rounded-md shadow-sm md:p-6  p-1">
          <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-2">
            ...
            <div className="text-center md:text-left">
              ...
              <div className="text-red-600 md:text-sm text-xs ">From :<span className=" font-semibold">({meetingTime})</span></div>
            </div>
          ...
          <div
            aria-label="Share"
            className="md:mt-3 mt-0 flex items-center space-x-2 text-indigo-900 font-semibold text-sm cursor-pointer md:-mb-3 -mb-0 "
            onClick={() => {
              const shareData = {
