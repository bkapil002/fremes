...
import Donation from './Dorate.png'
const Audience = () => {
    const audienceData = new Array(20).fill({
  name: "Prem Sinha",
  avatar: "https://media.istockphoto.com/id/1188562863/photo/grateful-happy-beautiful-indian-girl-holding-hands-on-chest.webp?b=1&s=612x612&w=0&k=20&c=ytIEZMUhzH-bNx-MXC-IoMIxMn1629Lz4uOLdmTp2_Y=0",
});
  return (
    <div>
      ...
      <div className="bg-white space-y-4 rounded-2xl h-60 shadow p-6 w-full max-w-xs mx-auto  flex flex-col items-center">
        <img src={Donation} className="text-5xl  mb-4"/>
      ...
      <div className="flex-1 bg-white rounded-2xl shadow">
        <div className="border-b px-6 py-4 text-lg font-semibold text-gray-800 flex items-center gap-2">
          ...
          Audience <span className="text-green-600">({audienceData.length})</span>
        </div>

        <div className="p-4 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
          {audienceData.map((user, i) => (
